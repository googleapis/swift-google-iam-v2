...
public struct DenyRule: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var deniedPrincipals: [Swift.String] = []
  ...
  /// the internet.
  public var exceptionPrincipals: [Swift.String] = []
  ...
  public var deniedPermissions: [Swift.String] = []
  ...
  /// `denied_permissions`.
  public var exceptionPermissions: [Swift.String] = []
  ...
  ///
  /// ```
  /// let value = DenyRule().with { $0.deniedPrincipals = ... }
  /// ```
